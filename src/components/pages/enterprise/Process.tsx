...
export default function EnterpriseProcess() {
  const steps = [
    { title: "Publiez", desc: "Une annonce claire avec vos critères et avantages." },
    { title: "Recevez", desc: "Des candidatures qualifiées en quelques heures." },
    { title: "Sélectionnez", desc: "Échangez, évaluez et signez depuis la plateforme." },
  ];
  return (
    <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      <h2 className="text-center text-xl font-semibold tracking-tight text-gray-900">Comment ça se passe</h2>
